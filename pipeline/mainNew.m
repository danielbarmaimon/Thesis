...
%path = '';
%path = '';
%path = 'C:\Users\Iram\Desktop\BU4DSpontatneous\Sequences(2D+3D)\F006\T1';
%path = 'C:\Users\Iram\Desktop\BU4DSpontatneous\Sequences(2D+3D)\F006\test';
%path = 'C:\Users\Iram\Desktop\BU4DSpontatneous\Sequences(2D+3D)\M001\T1';
%path = 'C:\Users\Iram\Desktop\BU4DSpontatneous\Sequences(2D+3D)\M001\test';
path = 'C:\Users\Daniel Barmaimon\Desktop\test\F010\T1';
%path = 'C:\Users\Daniel Barmaimon\Desktop\test4\M003\T1';
...
reduction = 0.8; % Amount of the plane over the face to consider
...
%     Xprincipal1= principalDirections1(:,1);
%     Yprincipal1 = principalDirections1(:,2);
%     Zprincipal1 = principalDirections1(:,3);
%     plot3([noseR,noseR + Xprincipal(1)], [noseC, noseC + Xprincipal(2)],[val,val + Xprincipal(3)], 'LineWidth', 5, 'Color', 'r'); % 3D coordinate axes
%     plot3([noseR,noseR + Yprincipal(1)], [noseC, noseC + Yprincipal(2)],[val,val + Yprincipal(3)], 'LineWidth', 5, 'Color', 'g');
%     plot3([noseR,noseR + Zprincipal(1)], [noseC, noseC + Zprincipal(2)],[val,val + Zprincipal(3)], 'LineWidth', 5, 'Color', 'b');
    plot3([noseR,noseR + 10*Xprincipal(1)], [noseC, noseC + 10*Xprincipal(2)],[val,val + 10*Xprincipal(3)], 'LineWidth', 5, 'Color', 'r'); % 3D coordinate axes
    plot3([noseR,noseR + 10*Yprincipal(1)], [noseC, noseC + 10*Yprincipal(2)],[val,val + 10*Yprincipal(3)], 'LineWidth', 5, 'Color', 'g');
    plot3([noseR,noseR + 10*Zprincipal(1)], [noseC, noseC + 10*Zprincipal(2)],[val,val + 10*Zprincipal(3)], 'LineWidth', 5, 'Color', 'b');
  
%     % PROJECTION POINTS ONTO PLANE
...
%         proj_X(j) = dot(points3Dface(j,:) - nose, Xprincipal');
%         proj_Y(j) = dot(points3Dface(j,:) - nose, Yprincipal');
%     end
